...
export const LEVEL_SCALING_TABLE = {
  ...
  2: { damage: 1, hit: 0, crit: 0 },
  3: { damage: 1, hit: 1, crit: 0 },
  4: { damage: 2, hit: 1, crit: 0 },
  5: { damage: 2, hit: 1, crit: 1 },
  6: { damage: 3, hit: 1, crit: 1 },
  7: { damage: 3, hit: 2, crit: 1 },
  8: { damage: 4, hit: 2, crit: 1 },
  9: { damage: 4, hit: 2, crit: 2 },
  10: { damage: 5, hit: 3, crit: 2 },
};
...
export const ARCHETYPE_WEAPON_TEMPLATES = {
  slasher: [
    ...
    createTemplate({ id: "nail-gun", name: "Nagelpistole", source: "Slasher-Set", archetypeId: "slasher", weaponRole: "ranged", attackMode: "ranged", range: 5, profileId: "precise_ranged", meleePenaltyHit: -1, baseDamage: 3, baseHit: 1, baseCrit: 0 }),
    createTemplate({ id: "butcher-hook", name: "Fleischerhaken", source: "Slasher-Set", archetypeId: "slasher", weaponRole: "special", profileId: "special_improv", baseDamage: 3, baseHit: 0, baseCrit: 0, weight: 10, signatureEffect: { type: "bleed", tier: 1 } }),
  ],
  adventure: [
    ...
    createTemplate({ id: "expedition-revolver", name: "Expeditionsrevolver", source: "Abenteuer-Set", archetypeId: "adventure", weaponRole: "ranged", attackMode: "ranged", range: 6, profileId: "precise_ranged", meleePenaltyHit: 0, baseDamage: 3, baseHit: 1, baseCrit: 1 }),
    createTemplate({ id: "torch-spear", name: "Fackelspeer", source: "Abenteuer-Set", archetypeId: "adventure", weaponRole: "special", handedness: "two-handed", profileId: "special_improv", baseDamage: 3, baseHit: 0, baseCrit: 0, weight: 10, signatureEffect: { type: "light_bonus", tier: 1 } }),
  ],
  space_opera: [
    createTemplate({ id: "plasma-blade", name: "Plasmaklinge", source: "Sci-Fi-Set", archetypeId: "space_opera", weaponRole: "oneHanded", profileId: "light_melee", baseDamage: 3, baseHit: 1, baseCrit: 0 }),
    createTemplate({ id: "energy-lance", name: "Energielanze", source: "Sci-Fi-Set", archetypeId: "space_opera", weaponRole: "twoHanded", handedness: "two-handed", profileId: "heavy_melee", baseDamage: 5, baseHit: -1, baseCrit: 0 }),
    createTemplate({ id: "ion-blaster", name: "Ionenblaster", source: "Sci-Fi-Set", archetypeId: "space_opera", weaponRole: "ranged", attackMode: "ranged", range: 7, profileId: "precise_ranged", meleePenaltyHit: -1, baseDamage: 3, baseHit: 2, baseCrit: 0 }),
  ...
  fantasy: [
    createTemplate({ id: "rune-sword", name: "Runenschwert", source: "Fantasy-Set", archetypeId: "fantasy", weaponRole: "oneHanded", profileId: "light_melee", baseDamage: 3, baseHit: 1, baseCrit: 0 }),
    createTemplate({ id: "greatsword", name: "Großschwert", source: "Fantasy-Set", archetypeId: "fantasy", weaponRole: "twoHanded", handedness: "two-handed", profileId: "heavy_melee", baseDamage: 5, baseHit: -1, baseCrit: 0 }),
    createTemplate({ id: "hunting-bow", name: "Jagdbogen", source: "Fantasy-Set", archetypeId: "fantasy", weaponRole: "ranged", attackMode: "ranged", range: 7, profileId: "precise_ranged", meleePenaltyHit: -4, baseDamage: 3, baseHit: 2, baseCrit: 1 }),
    createTemplate({ id: "moon-blade", name: "Mondklinge", source: "Fantasy-Set", archetypeId: "fantasy", weaponRole: "special", profileId: "special_improv", baseDamage: 3, baseHit: 1, baseCrit: 0, weight: 10, signatureEffect: { type: "crit_bonus", tier: 1 } }),
  ],
  creature_feature: [
    ...
    createTemplate({ id: "bone-saw", name: "Knochensäge", source: "Labor-Set", archetypeId: "creature_feature", weaponRole: "twoHanded", handedness: "two-handed", profileId: "heavy_melee", baseDamage: 5, baseHit: -1, baseCrit: 0 }),
    createTemplate({ id: "serum-launcher", name: "Serumwerfer", source: "Labor-Set", archetypeId: "creature_feature", weaponRole: "ranged", attackMode: "ranged", range: 5, profileId: "precise_ranged", meleePenaltyHit: -2, baseDamage: 3, baseHit: 1, baseCrit: 0 }),
  ...
  romcom: [
    ...
    createTemplate({ id: "sport-bow", name: "Sportbogen", source: "Rom-Com-Set", archetypeId: "romcom", weaponRole: "ranged", attackMode: "ranged", range: 6, profileId: "precise_ranged", meleePenaltyHit: -4, baseDamage: 3, baseHit: 2, baseCrit: 0 }),
  ...
  social_drama: [
    ...
    createTemplate({ id: "sledgehammer", name: "Vorschlaghammer", source: "Alltags-Set", archetypeId: "social_drama", weaponRole: "twoHanded", handedness: "two-handed", profileId: "heavy_melee", baseDamage: 5, baseHit: -1, baseCrit: 0 }),
    createTemplate({ id: "brick-throw", name: "Ziegelwurf", source: "Alltags-Set", archetypeId: "social_drama", weaponRole: "ranged", attackMode: "ranged", range: 4, profileId: "precise_ranged", meleePenaltyHit: -2, baseDamage: 3, baseHit: 0, baseCrit: 0 }),
  ...
  action: [
    createTemplate({ id: "combat-knife", name: "Kampfmesser", source: "Action-Set", archetypeId: "action", weaponRole: "oneHanded", profileId: "light_melee", baseDamage: 3, baseHit: 1, baseCrit: 0 }),
    createTemplate({ id: "breach-axe", name: "Taktische Brechaxt", source: "Action-Set", archetypeId: "action", weaponRole: "twoHanded", handedness: "two-handed", profileId: "heavy_melee", baseDamage: 5, baseHit: -1, baseCrit: 0 }),
    createTemplate({ id: "service-pistol", name: "Dienstpistole", source: "Action-Set", archetypeId: "action", weaponRole: "ranged", attackMode: "ranged", range: 6, profileId: "precise_ranged", meleePenaltyHit: 0, baseDamage: 3, baseHit: 2, baseCrit: 0 }),
  ...
  western: [
    createTemplate({ id: "bowie-knife", name: "Bowie-Messer", source: "Western-Set", archetypeId: "western", weaponRole: "oneHanded", profileId: "light_melee", baseDamage: 3, baseHit: 1, baseCrit: 1 }),
    createTemplate({ id: "ranch-shotgun", name: "Rancherflinte", source: "Western-Set", archetypeId: "western", weaponRole: "twoHanded", handedness: "two-handed", attackMode: "ranged", range: 4, profileId: "heavy_melee", meleePenaltyHit: -1, baseDamage: 5, baseHit: 0, baseCrit: 0 }),
    createTemplate({ id: "revolver", name: "Revolver", source: "Western-Set", archetypeId: "western", weaponRole: "ranged", attackMode: "ranged", range: 6, profileId: "precise_ranged", meleePenaltyHit: 0, baseDamage: 3, baseHit: 2, baseCrit: 1 }),
