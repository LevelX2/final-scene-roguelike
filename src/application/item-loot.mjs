...
export function createItemLootApi(context) {
  ...
  return {
    ...
    cycleContainerLootAction: chestService.cycleContainerLootAction,
    moveContainerLootFocus: chestService.moveContainerLootFocus,
    confirmContainerLootFocus: chestService.confirmContainerLootFocus,
